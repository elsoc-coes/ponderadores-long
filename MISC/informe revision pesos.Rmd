...
Por lo mismo, en lo que respecta al cuestionario, hemos elegido las variables: *Género del entrevistado*, *Nivel Educacional del Entrevistado*, *Tramo Etario del entrevistado al inicio del estudio*,y *Estado Civil del Entrevistado*. 
...
Otra fuente importante de información para ELSOC es la información territorial con la que cuenta el estudio. El Centro de Inteligencia Territorial perteneciente a la Universidad Adolfo Ibañez recopiló información geográfica de las zonas censales de los entrevistados en base a los resultados del Censo 2017. Una característica importante de estas variables es que son fijas para todos lo años del estudio y estas están agregadas a nivel de la zona censal de los entrevistados. Todas estas variables son continuas.

La variable *Densidad poblacional en km2* . La variable *Nivel de Escolaridad Promedio del jefe de Hogar* . La variable *Proporción de vivendas en condiciones de hacinamiento*  La variable *Tamaño promedio de personas por hogar*  La variable *Proporción de viviendas en condiciones precarias*.
