...
## Pesos transversales
Una consideración importante para entender la construcción de los ponderadores longitudinales es recordar los pesos de diseño y los ajustes de no respuesta de los pesos transversales. 
El detalle se encuentra en el manual de usuario ELSOC. Este informe se limita a reproducir el cálculo de la probabilidad de selección (cuyo inverso es el peso de diseño) y el ajuste por no respuesta.
...
Ahora bien, el primer paso propiamente longitudinal en la construcción de los ponderadores longitudinales es el ajuste por no respuesta a partir de la segunda ola de cada muestra. Este se realiza en dos pasos: Primero se hace una estimación de la probabilidad de participación en el estudio para una persona en un año en particular, y como segundo paso se modifican los pesos de diseño mediante celdas de ajuste a partir de los valores predichos del modelo y los estratos del diseño muestral del estudio. 
