...
Celdas de ajuste: a) Se agrupan los cuartiles de la distribución de los valores predichos del modelo, b) el ajuste final es la tasa de respuesta dentro de cada grupo.
...
class: inverse,middle,center
<h1> Celdas de ajuste </h1>
---
<h1> .morado[Sobre las celdas de ajuste] </h1>

Buscan evitar tener pesos sobre dispersos. 

Hace más robustos
a los pesos respecto a errores en la especificación de la función de medias. 
