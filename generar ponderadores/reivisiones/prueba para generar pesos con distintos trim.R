generar_pesos <- function(per_bajo,per_alto){
  ...
  #CELDAS ESTRATO
  elsoc_nr$pd_celdas_estrato_trm=trimpesos_unev(elsoc_nr,per_bajo,per_alto,"pd_celdas_estrato")$pd_trimmed
  # RAKING ------------------------------------------------------------------
  ...
  return(pesos_longitudinales_elsoc)
}
